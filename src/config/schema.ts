...
const FIELD_LABELS: Record<string, string> = {
  ...
  "channels.sga": "SGA (企业微信/飞书/钉钉)",
  "channels.sga.apiKey": "SGA API Key",
  "channels.sga.endpoint": "SGA Legacy Endpoint",
  "channels.sga.token": "SGA Legacy Token",
  "channels.sga.platforms": "SGA Platforms",
  "channels.sga.platforms.wechatcom": "企业微信 (WeCom)",
  "channels.sga.platforms.wechatcom.corpId": "企业微信 Corp ID",
  "channels.sga.platforms.wechatcom.agentId": "企业微信 Agent ID",
  "channels.sga.platforms.wechatcom.secret": "企业微信 Secret",
  "channels.sga.platforms.feishu": "飞书 (Feishu)",
  "channels.sga.platforms.feishu.appId": "飞书 App ID",
  "channels.sga.platforms.feishu.appSecret": "飞书 App Secret",
  "channels.sga.platforms.dingtalk": "钉钉 (DingTalk)",
  "channels.sga.platforms.dingtalk.clientId": "钉钉 Client ID",
  "channels.sga.platforms.dingtalk.clientSecret": "钉钉 Client Secret",
  "channels.sga.platforms.wechatmp": "微信公众号 (WeChat MP)",
  "channels.sga.platforms.wechatmp.appId": "公众号 App ID",
  "channels.sga.platforms.wechatmp.appSecret": "公众号 App Secret",
